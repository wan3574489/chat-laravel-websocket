...
var chat = {
    ...
    checkRob:function (packet_id) {
        var json = {"type": 35,"openid": config.openid,'roomid':chat.data.storage.getItem("roomid"),'packet_id':packet_id};
        chat.wsSend(JSON.stringify(json));
        return false;
    },

    rob:function (packet_id) {
        var json = {"type": 30,"openid": config.openid,'roomid':chat.data.storage.getItem("roomid"),'packet_id':packet_id};
        chat.wsSend(JSON.stringify(json));
        return false;
    },
    doLoginFromOpenid:function(openid){
        ...
        var json = {"type": chat.data.type,"openid": openid,'roomid':"roomid"};
        chat.wsSend(JSON.stringify(json));
        return false;
    },
    ...
    sendMessage : function(text){
        ...
        var json = {
            ...
            'roomid':chat.data.storage.getItem("roomid"),
            "message": text
        };
        chat.wsSend(JSON.stringify(json));
        return true;
